...
execute store result score @s danom run data get entity @e[tag=6_torreta_hitbox,scores={6_id=0},limit=1] Health

scoreboard players set @s danom3 100
scoreboard players operation @s danom *= @s danom3

scoreboard players operation @s danom /= @e[tag=6_torreta_hitbox,scores={6_id=0},limit=1] danom2
