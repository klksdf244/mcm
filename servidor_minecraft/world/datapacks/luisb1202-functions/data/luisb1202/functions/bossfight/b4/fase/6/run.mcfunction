...
#hyper armor
effect give @e[tag=boss] resistance 2 2 true


#cadenas
execute unless entity @e[tag=b4_animacion] unless entity @e[tag=b4_h4_deadlock] if score h2 boss matches 50.. run function luisb1202:bossfight/b4/h2/ini_koros
#aniquilacion
execute unless entity @e[tag=b4_animacion] unless entity @e[tag=b4_h2_espada] unless entity @p[tag=b4_h2_encadenado,gamemode=!spectator] unless entity @e[tag=b4_deadlock,limit=1] if score h4 boss matches 115.. run function luisb1202:bossfight/b4/h4/ini
#barridos
...
#area 
execute unless entity @e[tag=b4_animacion] unless entity @e[tag=b4_h1_target2] unless entity @e[tag=b4_h2_espada] unless entity @p[tag=b4_h2_encadenado,gamemode=!spectator] unless entity @e[tag=b4_deadlock,limit=1] if score h3 boss matches 51.. run function luisb1202:bossfight/b4/h3/ini_fast
