summon armor_stand ~ 51 ~ {Glowing:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:0b,Marker:1b,Invisible:1b,Tags:["b4_h7_as_core","b4_h7_as","b4_h7_as_ini","b4_h7_as_ini0"],Pose:{RightArm:[345f,225f,0f]},ArmorItems:[{},{},{},{}],HandItems:[{id:"black_concrete",Count:1b},{}]}
execute as @e[tag=b4_h7_as_ini] at @s run tp @s ~ ~ ~ facing -6383 51 1413
...
execute as @e[tag=b4_h7_as_ini2] at @s run tp @s ~ ~ ~ facing -6383 51 1413
...
execute as @e[tag=b4_h7_as_ini3] at @s run tp @s ~ ~ ~ facing -6383 51 1413
...
execute as @e[tag=b4_h7_as_ini4] at @s run tp @s ~ ~ ~ facing -6383 51 1413
...
scoreboard players set @e[tag=b4_h7_as_ini0] boss -30
