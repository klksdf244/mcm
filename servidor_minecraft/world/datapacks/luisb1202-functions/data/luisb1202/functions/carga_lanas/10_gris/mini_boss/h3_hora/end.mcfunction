scoreboard players set 10_h3_t danom 0
...
schedule clear luisb1202:carga_lanas/10_gris/mini_boss/h3_hora/run
...
schedule function luisb1202:carga_lanas/10_gris/mini_boss/h3_hora/end_end 2s