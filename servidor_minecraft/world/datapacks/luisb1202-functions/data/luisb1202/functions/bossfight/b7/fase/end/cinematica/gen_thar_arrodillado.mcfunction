...
summon armor_stand ~ ~-0.3 ~ {Rotation:[0f],Pose:{RightLeg:[-20f,0f,0f],LeftLeg:[-20f,0f,0f],RightArm:[0f,0f,10f],LeftArm:[0f,0f,-10f],Body:[0f,0f,0f],Head:[20f,0f,0f]},ShowArms:1b,NoBasePlate:true,NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Tags:["boss","hostile","b4_as","b4_as_head"],ArmorItems:[{},{id:"leather_leggings",Count:1b,tag:{display:{color:16777215}}},{id:"leather_chestplate",Count:1b,tag:{display:{color:16777215}}},{Count:1b,id:"player_head",tag:{SkullOwner:{Id:[I;-1799677634,1587104164,-1678250160,-84111072],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzg0MGNlMDFjNjlmOTk1MGFiZTVkNWIzYjI4YjEwMmIyMDg2MjM2MjhmZDI3NTU4NzNkM2QzZmM2YjZhOTk2YSJ9fX0="}]}}}}]}
...
playsound minecraft:entity.player.attack.crit master @a ~ ~ ~ 0.6 0.6
