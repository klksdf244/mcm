...
execute at @e[tag=forja_atacrom] run summon armor_stand ~ ~2 ~ {CustomNameVisible:1b,CustomName:'{"translate":"luisb1202.functions.forja.atacrom.gen.1","color":"#75FFCD"}',ShowArms:1b,NoBasePlate:1b,Glowing:0b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:0b,Marker:1b,Invisible:1b,Tags:["forja_atacrom_name_2"],DisabledSlots:4144959}
