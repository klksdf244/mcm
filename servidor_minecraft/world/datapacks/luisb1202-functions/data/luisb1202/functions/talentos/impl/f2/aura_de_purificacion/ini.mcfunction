...
effect give @s minecraft:resistance 4 0
execute as @s[nbt=!{Fire:-20s}] unless entity @e[tag=purificar_as] run function luisb1202:talentos/impl/f2/aura_de_purificacion/poner_agua
scoreboard players set @s purificar_cd 79
