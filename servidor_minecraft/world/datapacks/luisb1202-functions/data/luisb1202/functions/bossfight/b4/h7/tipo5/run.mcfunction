execute as @e[tag=b4_h7_angulo] at @s run tp @s ~ ~ ~ ~6 ~
...
execute if score b4_h7_t boss matches ..60 run schedule function luisb1202:bossfight/b4/h7/tipo5/run 1t
execute if score b4_h7_t boss matches 60.. run function luisb1202:bossfight/b4/h7/tipo5/end
