...
execute at @e[tag=hojarcana_ultima_core] run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Small:0b,Marker:1b,Invisible:1b,Tags:["hojarcana_ultima_as_ini","hojarcana_ultima_as","hojarcana_ultima_remove"]}
data modify entity @e[tag=hojarcana_ultima_as_ini,limit=1] Rotation[1] set value 20f
