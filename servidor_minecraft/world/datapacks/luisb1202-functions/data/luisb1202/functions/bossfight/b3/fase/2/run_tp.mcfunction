...
execute if score b3_h5_t boss matches 23 positioned 1533 109 1443 unless entity @e[tag=b3_h5_as,distance=..2] run scoreboard players remove b3_h5_t boss 1
...
execute if score b3_h5_t boss matches 31 run function luisb1202:bossfight/b3/barrera_plasma/ini_if1
execute if score b3_h5_t boss matches ..30 run schedule function luisb1202:bossfight/b3/fase/2/run_tp 1t
