...
tellraw @s ["",{"translate":"luisb1202.functions.carga_lanas.0_intro.elige_tu_destino.msg_arco.2"},{"translate":"luisb1202.functions.carga_lanas.0_intro.elige_tu_destino.msg_arco.3","clickEvent":{"action":"run_command","value":"/trigger dialogo set 1999"}},{"translate":"item.written_book.3.page.0.7"},{"translate":"luisb1202.functions.carga_lanas.0_intro.elige_tu_destino.msg_arco.4","clickEvent":{"action":"run_command","value":"/trigger dialogo set 1000"}}]
tellraw @s ["",{"translate":"empty"}]