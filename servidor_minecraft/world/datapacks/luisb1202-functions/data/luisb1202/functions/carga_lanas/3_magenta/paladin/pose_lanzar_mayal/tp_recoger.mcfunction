...
#brazo izq
execute at @s rotated ~ 0 positioned ^0.3 ^0.12 ^0.7 run function luisb1202:carga_lanas/3_magenta/paladin/tp_brazo_izq
...
#msg
execute unless score 3_msg_pala_mayal danom matches 1.. run schedule function luisb1202:carga_lanas/3_magenta/paladin/msg_pala_mayal 1s