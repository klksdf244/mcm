...
#alas
data modify entity @e[limit=1,scores={11_id=0},type=armor_stand,tag=11_mosquito_as_5] Pose set value {RightArm:[105f,0f,30f]}
data modify entity @e[limit=1,scores={11_id=0},type=armor_stand,tag=11_mosquito_as_6] Pose set value {RightArm:[75f,0f,30f]}
...
function luisb1202:carga_lanas/11_cian/mosquito/pose_pared