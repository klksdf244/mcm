...
data modify entity @e[tag=b4_as,limit=1] Pose merge value {Body:[0f,6f,0f],Head:[322f,340f,0f],LeftLeg:[4f,0f,0f],RightLeg:[10f,0f,0f],LeftArm:[0f,0f,300f],RightArm:[0f,0f,20f]}
...
execute unless entity @e[tag=ectron_b4_as] run function luisb1202:bossfight/b4/h4/frases