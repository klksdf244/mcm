...
execute at @s as @e[tag=14_montura_pata1,tag=14_montura_pata_up,scores={14_id2=0}] rotated ~15 ~ positioned ^-0.6 ^-0.45 ^0.35 run tp @s ~ ~ ~ ~ ~
execute at @s as @e[tag=14_montura_pata1,tag=14_montura_pata_suelo,scores={14_id2=0}] rotated ~15 ~ positioned ^-1.2 ^-0.8 ^0.35 run tp @s ~ ~ ~ ~ ~
...
execute at @s as @e[tag=14_montura_pata3,tag=14_montura_pata_up,scores={14_id2=0}] rotated ~255 ~ positioned ^-0.6 ^-0.45 ^0.35 run tp @s ~ ~ ~ ~ ~
execute at @s as @e[tag=14_montura_pata3,tag=14_montura_pata_suelo,scores={14_id2=0}] rotated ~255 ~ positioned ^-1.2 ^-0.8 ^0.35 run tp @s ~ ~ ~ ~ ~
