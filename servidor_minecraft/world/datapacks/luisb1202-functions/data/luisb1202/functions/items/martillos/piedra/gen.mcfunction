...
summon armor_stand ~ ~-3 ~ {DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:0b,Marker:0b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_1"],HandItems:[{id:"minecraft:polished_andesite",Count:1b},{}]}
summon armor_stand ~ ~-3 ~ {DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:1b,Marker:0b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_2"],HandItems:[{id:"minecraft:polished_andesite",Count:1b},{}]}
summon armor_stand ~ ~-3 ~ {DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:0b,Marker:0b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_3"],HandItems:[{id:"minecraft:polished_andesite",Count:1b},{}]}

#sfx
playsound minecraft:ui.toast.out master @a ~ ~ ~ 0.5 1.1
playsound minecraft:item.armor.equip_chain master @a ~ ~ ~ 1 0.6
#vector 
...
tag @e[tag=martillo_ini] add martillo_piedra
