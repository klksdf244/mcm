...
execute unless score omegatridente_forja danom matches 1 run scoreboard players set dano_handler danom 9
execute if score omegatridente_forja danom matches 1 run scoreboard players set dano_handler danom 15
