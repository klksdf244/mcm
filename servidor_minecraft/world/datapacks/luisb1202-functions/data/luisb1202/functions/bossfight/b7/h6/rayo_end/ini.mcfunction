...
execute as @e[tag=b7_h6_rayo1,limit=1] at @s facing entity @e[tag=b7_h6_suelo1,limit=1] eyes run function luisb1202:bossfight/b7/h6/rayo_end/recu
execute as @e[tag=b7_h6_rayo2,limit=1] at @s facing entity @e[tag=b7_h6_suelo2,limit=1] eyes run function luisb1202:bossfight/b7/h6/rayo_end/recu
