...
execute at @e[tag=b2_core] run summon armor_stand ~ ~0.4 ~ {Team:purple,Glowing:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["b2_h6_as","b2_h6_as7","b2_h6_as_ini"],ArmorItems:[{},{},{},{id:"black_concrete",Count:1}]}
...
execute as @e[tag=b2_h6_as1,tag=b2_h6_as_ini] at @s run tp @s ~ ~ ~ ~30 0
execute as @e[tag=b2_h6_as2,tag=b2_h6_as_ini] at @s run tp @s ~ ~ ~ ~20 0
execute as @e[tag=b2_h6_as3,tag=b2_h6_as_ini] at @s run tp @s ~ ~ ~ ~10 0
execute as @e[tag=b2_h6_as4,tag=b2_h6_as_ini] at @s run tp @s ~ ~ ~ ~0 0
execute as @e[tag=b2_h6_as5,tag=b2_h6_as_ini] at @s run tp @s ~ ~ ~ ~-10 0
execute as @e[tag=b2_h6_as6,tag=b2_h6_as_ini] at @s run tp @s ~ ~ ~ ~-20 0
execute as @e[tag=b2_h6_as7,tag=b2_h6_as_ini] at @s run tp @s ~ ~ ~ ~-30 0
