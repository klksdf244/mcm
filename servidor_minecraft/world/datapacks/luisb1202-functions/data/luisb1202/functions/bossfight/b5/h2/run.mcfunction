...
execute as @e[tag=b5_h2_bomb] at @s if block ~ ~1.2 ~ water run function luisb1202:bossfight/b5/h2/boom

execute at @e[tag=b5_h2_selecto] if predicate luisb1202:random2 run particle minecraft:end_rod ~ ~1 ~ 0.3 0.3 0.3 0 1 force

execute if score b5_h2_vision boss matches 90.. as @e[tag=b5_h2_bomb] at @s run tp @s ~ ~ ~ ~11 ~
execute if score b5_h2_vision boss matches 90.. as @e[tag=b5_h2_bomb] at @s positioned ^ ^ ^1.2 unless block ~ 48 ~ air run particle firework ~ 49 ~
execute if score b5_h2_vision boss matches 90.. as @e[tag=b5_h2_bomb] at @s positioned ^ ^ ^-1.2 unless block ~ 48 ~ air run particle firework ~ 49 ~