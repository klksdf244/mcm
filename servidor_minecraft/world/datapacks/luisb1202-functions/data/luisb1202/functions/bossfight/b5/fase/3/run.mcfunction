...
#test fase
execute if score boss_vida2 boss matches ..6 if score b5_shield_change boss matches 0 run function luisb1202:bossfight/b5/h1/switch
execute if score boss_vida boss matches ..6 run function luisb1202:bossfight/b5/fase/4/ini
