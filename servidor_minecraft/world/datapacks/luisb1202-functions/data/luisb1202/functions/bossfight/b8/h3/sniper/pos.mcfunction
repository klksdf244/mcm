...
execute as @e[tag=b8_h3_enemigo2] at @s run kill @e[tag=b8_h3_pos,sort=nearest,limit=1]

execute as @a[gamemode=!spectator] at @s run kill @e[tag=b8_h3_pos,distance=..10]
execute as @e[tag=b8_h3_pos,limit=2,sort=random] at @s run function luisb1202:bossfight/b8/h3/sniper/gen
execute as @a[gamemode=!spectator] as @e[tag=b8_h3_pos,limit=1,sort=random] at @s run function luisb1202:bossfight/b8/h3/sniper/gen
