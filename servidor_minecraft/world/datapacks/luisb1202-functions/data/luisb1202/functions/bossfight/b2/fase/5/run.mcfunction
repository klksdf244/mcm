...
execute unless entity @e[tag=b2_h8_mob_custodio] if score boss_vida boss matches ..15 unless entity @e[tag=b2_cd_animation] run function luisb1202:bossfight/b2/fase/6/ini
...
execute unless score boss_vida boss matches ..15 unless entity @e[tag=b2_cd_animation] if score h3 boss matches 25.. run function luisb1202:bossfight/b2/h3/ini_doble
...
execute if score h81 boss matches 60.. run function luisb1202:bossfight/b2/h8/ini_custodio
