...
execute as @e[tag=b8_h3_pos,limit=8,sort=random] at @s run function luisb1202:bossfight/b8/h3/zombie_robot/gen
execute as @a[gamemode=!spectator] as @e[tag=b8_h3_pos,limit=4,sort=random] at @s run function luisb1202:bossfight/b8/h3/zombie_robot/gen
