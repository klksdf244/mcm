...
#pasiva
execute unless score martillo_electrico_cd danom matches 1.. run function luisb1202:items/martillos/electrico/ini_rafaga
...
summon armor_stand ~ ~-3 ~ {Team:"aqua",Glowing:1b,DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:0b,Marker:1b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_1"],HandItems:[{id:"minecraft:black_concrete",Count:1b},{}]}
summon armor_stand ~ ~-3 ~ {Team:"aqua",Glowing:1b,DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_2"],HandItems:[{id:"minecraft:black_concrete",Count:1b},{}]}
summon armor_stand ~ ~-3 ~ {Team:"aqua",Glowing:1b,DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:0b,Marker:1b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_3"],HandItems:[{id:"minecraft:black_concrete",Count:1b}]}

#sfx
playsound minecraft:entity.puffer_fish.blow_out ambient @a ~ ~ ~ 1 0.4
...
tag @e[tag=martillo_ini] add martillo_electrico
