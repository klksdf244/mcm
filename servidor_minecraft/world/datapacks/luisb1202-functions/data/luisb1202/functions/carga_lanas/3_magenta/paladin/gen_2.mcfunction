...
summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["3_paladin_core","3_paladin_as","3_paladin_as_ini"],DisabledSlots:4144959}
execute as @e[tag=3_paladin_core,tag=3_paladin_as_ini] run tp @s ~ ~ ~ ~-90 0

function luisb1202:carga_lanas/3_magenta/paladin/gen_3
