...
summon armor_stand -913 159 -67 {NoGravity:1b,Silent:1b,Invulnerable:1b,Small:0b,Marker:1b,Invisible:1b,Tags:["b7_h10_ataque","b7_h8_ataque1","b7_h8_proyectil","b7_h8_ataque_as","b7_h8_ataque_as_ini","b7_h8_ilusion"],DisabledSlots:4144959}
