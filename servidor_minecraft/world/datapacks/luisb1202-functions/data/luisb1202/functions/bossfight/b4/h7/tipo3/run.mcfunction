...
execute if score b4_h7_t boss matches ..90 run schedule function luisb1202:bossfight/b4/h7/tipo3/run 1t
execute if score b4_h7_t boss matches 90.. run function luisb1202:bossfight/b4/h7/tipo3/end