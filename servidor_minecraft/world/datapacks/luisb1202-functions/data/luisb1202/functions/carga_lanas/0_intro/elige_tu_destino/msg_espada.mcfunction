...
tellraw @s ["",{"translate":"luisb1202.functions.bossfight.b4.dialogos.dia10.1","bold":true,"italic":true,"color":"dark_red"},{"translate":"luisb1202.functions.carga_lanas.0_intro.elige_tu_destino.msg_espada.1","color": "red"}]
tellraw @s ["",{"translate":"empty"}]
function luisb1202:talentos/impl/f0/espada/tooltip
tellraw @s ["",{"translate":"empty"}]
