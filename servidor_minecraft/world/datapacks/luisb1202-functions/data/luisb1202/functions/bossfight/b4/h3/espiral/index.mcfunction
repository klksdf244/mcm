...
particle minecraft:squid_ink ^16 ^0.1 ^ 0 0 0 0 0 force
particle minecraft:squid_ink ^-16 ^0.1 ^ 0 0 0 0 0 force
particle minecraft:squid_ink ^ ^0.1 ^16 0 0 0 0 0 force
particle minecraft:squid_ink ^ ^0.1 ^-16 0 0 0 0 0 force

execute at @s run tp @s ~ ~ ~ ~7 ~
scoreboard players set @s[scores={danom=36..}] danom 0
