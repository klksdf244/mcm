scoreboard players add @e[tag=10_aguja_onirica_reloj_core,scores={danom=..0}] danom 0
scoreboard players set @e[tag=10_aguja_onirica_reloj_core,scores={danom=..0}] danom 12
...
scoreboard players remove @e[tag=10_aguja_onirica_reloj_core] danom 1
