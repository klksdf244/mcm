...
summon armor_stand ~ ~-3 ~ {DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:0b,Marker:0b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_1"],HandItems:[{id:"minecraft:blue_ice",Count:1b,tag:{Enchantments:[]}},{}]}
summon armor_stand ~ ~-3 ~ {DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:1b,Marker:0b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_2"],HandItems:[{id:"minecraft:blue_ice",Count:1b,tag:{Enchantments:[]}},{}]}
summon armor_stand ~ ~-3 ~ {DisabledSlots:4144959,Pose:{RightArm:[345f,45f,90f]},NoGravity:1b,Invulnerable:1b,Small:0b,Marker:0b,Invisible:1b,Tags:["martillo_ini","martillo","martillo_3"],HandItems:[{id:"minecraft:blue_ice",Count:1b,tag:{Enchantments:[]}},{}]}
...
tag @e[tag=martillo_ini] add martillo_diamante
