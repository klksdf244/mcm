...
execute if score 100_check_carbon danom matches 0 run function luisb1202:carga_lanas/100_maquina_diamantes/give_exito


execute as @e[tag=100_diamante] run data modify entity @s Fire set value 0 
