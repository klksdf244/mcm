...
execute at @s as @e[tag=14_acechador_pata2,tag=14_acechador_pata_up,scores={14_id=0}] rotated ~165 ~ positioned ^-0.6 ^-0.45 ^0.35 run tp @s ~ ~ ~ ~ ~
execute at @s as @e[tag=14_acechador_pata2,tag=14_acechador_pata_suelo,scores={14_id=0}] rotated ~165 ~ positioned ^-1.2 ^-0.8 ^0.35 run tp @s ~ ~ ~ ~ ~
...
execute at @s as @e[tag=14_acechador_pata4,tag=14_acechador_pata_up,scores={14_id=0}] rotated ~285 ~ positioned ^-0.6 ^-0.45 ^0.35 run tp @s ~ ~ ~ ~ ~
execute at @s as @e[tag=14_acechador_pata4,tag=14_acechador_pata_suelo,scores={14_id=0}] rotated ~285 ~ positioned ^-1.2 ^-0.8 ^0.35 run tp @s ~ ~ ~ ~ ~
