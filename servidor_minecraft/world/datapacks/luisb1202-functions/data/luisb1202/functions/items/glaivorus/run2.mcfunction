...
#dano a enemigos
execute as @e[tag=glaivorus_gen_as,scores={glaivorus=72..85}] at @s positioned ^-1.5 ^2.8 ^ run function luisb1202:items/glaivorus/hit_enemigos
execute as @e[tag=glaivorus_gen_as,scores={glaivorus=72..85}] at @s positioned ^ ^2.8 ^ run function luisb1202:items/glaivorus/hit_enemigos
