scoreboard players set b2_cast boss2 0

function luisb1202:bossfight/b2/thar_kroo/animacion_cast/pose2
...
schedule function luisb1202:bossfight/b2/thar_kroo/animacion_cast/run_right 5t