...
#brazo izq
execute at @s positioned ^0.3 ^0.25 ^ rotated ~-110 0 positioned ^-0.8 ^0.22 ^0.7 run function luisb1202:carga_lanas/3_magenta/paladin/tp_brazo_izq

#brazo der
execute at @s positioned ^0.3 ^0.25 ^ rotated ~-110 0 run tp @e[tag=3_paladin_14,type=armor_stand,scores={3_id2=0},limit=1] ^-0.85 ^-0.28 ^-0.7 ~ ~
execute at @s positioned ^0.3 ^0.25 ^ rotated ~-110 0 run tp @e[tag=3_paladin_15,type=armor_stand,scores={3_id2=0},limit=1] ^-0.6 ^0.0 ^-0.7 ~ ~

execute if score @s aux2 matches 5 at @s run playsound entity.bat.takeoff master @a ~ ~ ~ 1 0.6
