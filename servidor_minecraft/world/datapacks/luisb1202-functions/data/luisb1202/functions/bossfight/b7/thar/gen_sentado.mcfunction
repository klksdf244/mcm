...
summon armor_stand ~ ~ ~ {Rotation:[90f],Pose:{RightLeg:[-80f,-30f,0f],LeftLeg:[-40f,15f,0f],RightArm:[-30f,0f,110f],LeftArm:[10f,0f,-40f],Body:[0f,-20f,0f],Head:[-2f,0f,5f]},ShowArms:1b,NoBasePlate:true,NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Tags:["b4_as"],ArmorItems:[{},{},{id:"leather_chestplate",Count:1b,tag:{display:{color:16777215}}},{Count:1b,id:"player_head",tag:{SkullOwner:{Id:[I;-1799677634,1587104164,-1678250160,-84111072],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzg0MGNlMDFjNjlmOTk1MGFiZTVkNWIzYjI4YjEwMmIyMDg2MjM2MjhmZDI3NTU4NzNkM2QzZmM2YjZhOTk2YSJ9fX0="}]}}}}]}
summon armor_stand ~ ~ ~ {Invisible:1b,Rotation:[90f],Pose:{RightLeg:[-80f,-30f,0f],LeftLeg:[-40f,15f,0f],RightArm:[-30f,0f,110f],LeftArm:[10f,0f,-40f],Body:[0f,-20f,0f],Head:[-8f,0f,5f]},ShowArms:1b,NoBasePlate:true,NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Tags:["b4_as2"],ArmorItems:[{id:"leather_boots",Count:1b,tag:{display:{color:16711680}}},{id:"leather_leggings",Count:1b,tag:{display:{color:16777215}}},{},{}]}
...
#espada
execute at @e[tag=b4_as] positioned ^-0.6 ^0.25 ^0.35 run summon armor_stand ~ ~ ~ {Rotation:[70f,170f],NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["b4_espada_pos"],DisabledSlots:4144959}
