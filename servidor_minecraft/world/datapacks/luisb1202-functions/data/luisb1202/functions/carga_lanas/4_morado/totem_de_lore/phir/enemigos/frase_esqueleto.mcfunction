...
execute if entity @e[tag=b4_h1_dialogo_1,tag=trigger] run tellraw @a[distance=..80,tag=!4_dialogo] ["",{"translate":"luisb1202.functions.carga_lanas.4_morado.totem_de_lore.phir.enemigos.frase_esqueleto.1","bold":true,"italic":true,"color":"#BCF26E"},{"translate":"luisb1202.functions.carga_lanas.4_morado.totem_de_lore.phir.enemigos.frase_centinela_bani.2"}]
execute if entity @e[tag=b4_h1_dialogo_2,tag=trigger] run tellraw @a[distance=..80,tag=!4_dialogo] ["",{"translate":"luisb1202.functions.carga_lanas.4_morado.totem_de_lore.phir.enemigos.frase_esqueleto.1","bold":true,"italic":true,"color":"#BCF26E"},{"translate":"luisb1202.functions.carga_lanas.4_morado.totem_de_lore.phir.enemigos.frase_esqueleto.2"}]
execute if entity @e[tag=b4_h1_dialogo_3,tag=trigger] run tellraw @a[distance=..80,tag=!4_dialogo] ["",{"translate":"luisb1202.functions.carga_lanas.4_morado.totem_de_lore.phir.enemigos.frase_esqueleto.1","bold":true,"italic":true,"color":"#BCF26E"},{"translate":"luisb1202.functions.carga_lanas.4_morado.totem_de_lore.phir.enemigos.frase_esqueleto.3"}]
