...
execute at @s as @e[tag=14_acechador_pata1,tag=14_acechador_pata_up,scores={14_id=0}] rotated ~40 ~ positioned ^-0.6 ^-0.1 ^0.45 run tp @s ~ ~ ~ ~ ~
execute at @s as @e[tag=14_acechador_pata1,tag=14_acechador_pata_suelo,scores={14_id=0}] rotated ~40 ~ positioned ^-0.6 ^-0.1 ^0.45 run tp @s ~ ~ ~ ~ ~
...
execute at @s as @e[tag=14_acechador_pata3,tag=14_acechador_pata_up,scores={14_id=0}] rotated ~240 ~ positioned ^-0.6 ^-0.1 ^0.45 run tp @s ~ ~ ~ ~ ~
execute at @s as @e[tag=14_acechador_pata3,tag=14_acechador_pata_suelo,scores={14_id=0}] rotated ~240 ~ positioned ^-0.6 ^-0.1 ^0.45 run tp @s ~ ~ ~ ~ ~
